...
# Determine the frontend root directory dynamically
FRONTEND_ROOT = os.path.abspath(os.path.dirname(__file__))
LOGS_DIR = os.path.join(FRONTEND_ROOT, "logs")
...
def get_custom_logger(name: str, log_file: str) -> logging.Logger:
    ...
    and a specific log file in the frontend/logs directory (FileHandler).
    """
